...
<!-- 
	...
	웹 경로 : http://localhost:8090/WebJSP/Ex09_WebApp_RealPath.jsp 
	Ex09_WebApp_RealPath.jsp 실제 서버의 물리적인 경로는 어디일까요~??
	
	실경로(소스) : C:\WEB(Back)\WebLabs\WebJSP\WebContent\Ex09_WebApp_RealPath.jsp
	실제 소스 : [배포] 되어서 서비스 되고 있는 소스 >> 톰캣이 가지는 특정 경로
	
	***[동기화] 있어서 [하나 처럼] 움직입니당
	
	아파치 톰캣의 서비스 경로(배포)
	C:\WEB(Back)\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
	
	resourcepath >> /download/note.txt
	소스 경로 :  C:\WEB(Back)\WebLabs\WebJSP\WebContent\download/note.txt(실제소스경로)
	배포 경로 :  C:\WEB(Back)\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
 -->
 <%
 	...
 	out.print("ContextPath를 통한 real path : " + realContextPath + "<br>");
